...
class UriBuilderText extends \TYPO3\CMS\Core\Tests\FunctionalTestCase
{
    ...
    public function setUp()
    {
        ...
        $typoScriptFrontendController = GeneralUtility::makeInstance('TYPO3\\CMS\\Frontend\\Controller\\TypoScriptFrontendController',
    ...
    public function frontendUriBuilderCreatesLinkHandlerUrl()
    {
        ...
        $this->assertEquals('index.php?id=1&tx_news_pi1%5Bnews%5D=1&tx_news_pi1%5Bcontroller%5D=News&tx_news_pi1%5Baction%5D=detail',
                $generatedUrl);
    }
    ...
    public function frontendUriBuilderParametersArePassedOnIfConfigured()
    {
        ...
        $generatedUrl = $this->uriBuilder->buildFrontendUri();
        $this->assertEquals('index.php?id=1&no_cache=1&tx_news_pi1%5Bnews%5D=1&tx_news_pi1%5Bcontroller%5D=News&tx_news_pi1%5Baction%5D=detail',
                $generatedUrl);
    }
}
